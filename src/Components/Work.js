...
const Work = () => {
  return (
    <div name='work' className='w-full md:h-screen text-gray-300 bg-[#f5f5f5]  mt-60 text-center'>
      <div className='max-w-[2000px] mx-auto p-4 flex flex-col justify-center w-full h-full '>
        <div className='pb-8'>
          <p className='text-6xl font-bold inline border-b-4 border-pink-600 text-[#0a192f]'>
            Work
          </p>
          <p className='py-6 text-[#0a192f]'>// Check out some of my recent work</p>
        </div>
